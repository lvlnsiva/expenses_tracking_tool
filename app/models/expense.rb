class Expense < ActiveRecord::Base
  ...
  def validate_spent_on 
    puts "spent_on.inspect >> #{spent_on.inspect}"
    errors.add(:spent_on, "date should not be greater than current date") if spent_on.present? && spent_on.to_date > Date.today
  end
  def convert_date
